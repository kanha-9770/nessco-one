...
const Section: React.FC<SectionProps> = ({
  ...
  return (
    <div className="flex lg:flex-row flex-col lg:p-8 p-6 mb-6 bg-black text-white rounded-[0.8rem] shadow-md font-poppins">
      <div className="lg:w-[80%] space-y-3">
        <h2 className="lg:text-3xl text-2xl font-medium">
          {number}. {title}
        </h2>
        <div className="border-t-2 w-[45%] ml-7"></div>
        <p className="text-md lg:text-left text-justify font-regular lg:ml-7">{description}</p>
      </div>
      <div className="flex flex-col lg:w-[20%] items-center justify-center space-y-4 relative">
        ...
        <LinkUrl href={`/knowledge-center/${link}`}
          className="group flex items-center justify-center text-white lg:hover:text-[#8c52ff] lg:absolute lg:bottom-0 lg:left-1/2 lg:transform lg:-translate-x-1/2"
        >
          {button}
          <svg
