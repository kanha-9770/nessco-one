    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          const distance = calculateDistance(latitude, longitude, destinationLat, destinationLng);
  
          if (distance < 0.1) { // If distance is less than 100 meters
