  ...
  return (
    <main className="relative bg-[#f2f2f2] top-14 gap-2 h-full ">
      ...
      <div className="h-full font-poppins">
        ...
        <div id="knowMore" className="h-auto px-8" ref={sectionRefs.knowMoreRef}>
          <KnowMore heroData={homeData} />
        </div>
        ...
        <div id="testimonials" className="relative bg-gradient-to-l via-purple-200 to-transparent h-screen " ref={sectionRefs.homeTestimonialRef}>
          <HomeTestimonial heroData={homeData} />
        </div>
      </div>
    </main>
