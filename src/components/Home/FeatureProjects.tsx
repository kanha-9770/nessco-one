...
//   return (
//     <div className="w-full h-full px-2 sm:px-4 md:px-14 font-poppins max-w-screen-2xl mx-auto">
...
//           <div className="text-center flex flex-col space-y-1 sm:space-y-2">
...
//             <button
//               className="h-6 w-6 sm:h-8 sm:w-8 bg-[#9e9c9c] flex hover:bg-black rounded-full items-center justify-center"
//               onClick={scrollLeft}
//             >
//               <svg
...
//             </button>
//             <button
//               className="h-6 w-6 sm:h-8 sm:w-8 bg-[#9e9c9c] hover:bg-black rounded-full flex items-center justify-center"
//               onClick={scrollRight}
//             >
//               <svg
//                 xmlns="http://www.w3.org/2000/svg"
    ...
    <div className="w-full h-full px-4 md:px-14 font-poppins max-w-screen-2xl mx-auto">
      <div className="flex flex-col md:flex-row rounded-3xl mt-2 md:my-4 bg-white p-2">
        ...
        <div
          ...
          onMouseLeave={handleMouseLeave}
        >
          <div className="overflow-auto scrollbar-hide h-full px-1 flex" ref={carouselRef}>
            <div className="w-max flex items-center justify-center space-x-2">
              {[...relatedProduct?.imageWithDescription, ...relatedProduct?.imageWithDescription].map((item, idx) => (
                <div
                  key={idx}
