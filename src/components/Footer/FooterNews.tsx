...
const FooterNew: React.FC<FooterProps> = ({ footerData }) => {
  ...
  return (
    <>
      ...
      <a href="https://www.facebook.com/NesscoPaperCupMachine" target="_blank" rel="noopener noreferrer" aria-label="Visit our Facebook page">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
          y="0px"
      ...
      <a href="https://x.com/NesscoIndia" target="_blank" rel="noopener noreferrer" aria-label="Visit our X (formerly Twitter) page">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
          y="0px"
      ...
      <a href="https://www.youtube.com/c/NesscoPaperCupMachine" target="_blank" rel="noopener noreferrer" aria-label="Visit our YouTube channel">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
          y="0px"
      ...
      <a href="https://www.instagram.com/nesscoindia/" target="_blank" rel="noopener noreferrer" aria-label="Visit our Instagram page">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
          y="0px"
      ...
      <a href="https://www.linkedin.com/company/nesscoindia/" target="_blank" rel="noopener noreferrer" aria-label="Visit our LinkedIn page">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
          y="0px"
