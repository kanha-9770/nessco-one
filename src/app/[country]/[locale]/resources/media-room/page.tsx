...
import seoData from "@/components/Constants/media-room/media-room_data.json";
import { Metadata } from "next";

// Define MediaRoomSeoData interface to match your JSON structure
interface MediaRoomSeoData {
  title: string;
  description: string;
  keywords: string;
  openGraph: {
...
export async function generateMetadata(): Promise<Metadata> {
  const metadata: MediaRoomSeoData | undefined =
    seoData?.mediaRoomSeoData;
