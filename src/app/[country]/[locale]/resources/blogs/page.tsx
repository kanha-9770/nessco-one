...
import seoData from "@/components/Constants/blogs/blogs_data.json";
import { Metadata } from "next";

// Define BlogsSeoData interface to match your JSON structure
interface BlogsSeoData {
  title: string;
  description: string;
  keywords: string;
  openGraph: {
...
export async function generateMetadata(): Promise<Metadata> {
  const metadata: BlogsSeoData | undefined = seoData.blogsSeoData;
